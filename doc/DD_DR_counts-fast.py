...
for key in colours.keys():
    ...
    val = colours[key]
    RA1, DEC1 = targets['RA'][val], targets['DEC'][val]
    ...
    np.save('/global/cscratch1/sd/qmxp55/bgstargets_output/dr9/clustering/pair_counts/DD_DR_decals_16_%s.npy' %(key), pairs2)